...
namespace mopo {
  ...
  const ValueDetails ValueDetailsLookup::parameter_list[] = {
    ...
    { "arp_gate", 0.0, 1.0, 0, 0.5, 0.0, 1.0,
    ...
    { "beats_per_minute", 20.0, 300.0, 0, 120.0, 0.0, 1.0,
    ...
    { "distortion_drive", -30.0, 30.0, 0, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, "dB", "Distortion Drive" },
    ...
    { "filter_shelf", 0.0, 2.0, 3, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, "", "Filter Shelf" },
    { "filter_on", 0.0, 1.0, 2, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, "", "Filter Switch" },
    ...
    { "mono_lfo_1_retrigger", 0.0, 2.0, 3, 0.0, 0.0, 1.0,
    ...
    { "mono_lfo_2_retrigger", 0.0, 2.0, 3, 0.0, 0.0, 1.0,
    ...
    { "osc_1_waveform", 0.0, 10.0, 11, 0.0, 0.0, 1.0,
    ...
    { "osc_2_waveform", 0.0, 10.0, 11, 0.0, 0.0, 1.0,
    ...
    { "step_seq_00", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 1" },
    { "step_seq_01", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 2" },
    { "step_seq_02", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 3" },
    { "step_seq_03", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 4" },
    { "step_seq_04", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 5" },
    { "step_seq_05", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 6" },
    { "step_seq_06", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 7" },
    { "step_seq_07", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 8" },
    { "step_seq_08", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 9" },
    { "step_seq_09", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 10" },
    { "step_seq_10", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 11" },
    { "step_seq_11", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 12" },
    { "step_seq_12", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 13" },
    { "step_seq_13", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 14" },
    { "step_seq_14", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 15" },
    { "step_seq_15", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 16" },
    { "step_seq_16", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 17" },
    { "step_seq_17", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 18" },
    { "step_seq_18", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 19" },
    { "step_seq_19", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 20" },
    { "step_seq_20", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 21" },
    { "step_seq_21", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 22" },
    { "step_seq_22", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 23" },
    { "step_seq_23", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 24" },
    { "step_seq_24", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 25" },
    { "step_seq_25", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 26" },
    { "step_seq_26", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 27" },
    { "step_seq_27", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 28" },
    { "step_seq_28", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 29" },
    { "step_seq_29", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 30" },
    { "step_seq_30", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 31" },
    { "step_seq_31", -1.0, 1.0, 0, 0.0, 0.0, 1.0, ValueDetails::kLinear, "", "Step 32" },
    { "step_sequencer_retrigger", 0.0, 2.0, 3, 0.0, 0.0, 1.0,
    ...
    { "sub_transpose", -12.0, 12.0, 25, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, "semitones", "Sub Osc Transpose" },
    { "sub_tune", -1.0, 1.0, 0, 0.0, 0.0, 100.0,
