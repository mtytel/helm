...
namespace mopo {
  ...
  const ValueDetails ValueDetailsLookup::parameter_list[] = {
    ...
    { "stutter_frequency", -7.0, 6.0, 0, 3.0, 1.0,
    ...
    { "stutter_resample_tempo", 0.0, 11.0, 12, 7.0, 1.0,
      ValueDetails::kLinear, "", "Stutter Tempo" },
    { "stutter_softness", 0.0, 1.0, 0, 0.0, 100.0,
