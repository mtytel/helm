...
namespace mopo {
  ...
  const ValueDetails ValueDetailsLookup::parameter_list[] = {
    ...
    { "beats_per_minute", 20.0, 300.0, 0, 120.0, 0.0, 1.0,
      ValueDetails::kLinear, false, "bpm", "BPM" },
    ...
    { "fil_env_depth", -128.0, 128.0, 0, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, false, "", "Filter Env Depth" },
    ...
    { "reverb_dry_wet", 0.0, 1.0, 0, 0.5, 0.0, 1.0,
      ValueDetails::kLinear, false, "", "Reverb Wetness" },
    ...
    { "sub_transpose", -12.0, 12.0, 25, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, false, "semitones", "Sub Osc Transpose" },
    { "sub_tune", -1.0, 1.0, 0, 0.0, 0.0, 100.0,
      ValueDetails::kLinear, false, "cents", "Sub Osc Tune" },
