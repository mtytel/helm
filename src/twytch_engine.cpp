...
namespace mopo {
  ...
  std::vector<std::string> TwytchEngine::getModulationDestinations() {
    return voice_handler_->getModulationDestinations();
  }

  const Processor::Output* TwytchEngine::getModulationSourceOutput(std::string name) {
